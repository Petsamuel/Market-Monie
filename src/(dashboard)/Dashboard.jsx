    ...
    <div className="space-y-8 animate-in fade-in duration-700 font-poppins pb-16">
      <section className="flex flex-col gap-6">
        ...
        {(loanStage === 'Guest' || loanStage === 'Submitted') && (
          <div className="bg-white border border-gray-100/80 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 hover:shadow-lg hover:shadow-emerald-950/2 transition-all duration-300">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h4 className="text-xs md:text-sm font-bold text-gray-800 font-poppins">Need assistance with your account or loan?</h4>
            ...
            <button 
              ...
              className="w-full sm:w-auto px-5 py-3.5 bg-emerald-50 hover:bg-emerald-100/80 text-emerald-800 font-bold text-xs rounded-xl flex items-center justify-center gap-2 hover:gap-3 transition-all duration-300"
            >
      ...
      <div className="border border-dashed border-gray-200 rounded-3xl p-6 mt-8 bg-gray-50/50">
        ...
        {loanStage === 'Submitted' && (
          <div className="p-4 bg-white border border-gray-150 rounded-2xl animate-in slide-in-from-top-2 duration-300">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-3 py-2 text-[11px] font-bold rounded-lg transition-all cursor-pointer ${
                    appStatus === stage.key 
