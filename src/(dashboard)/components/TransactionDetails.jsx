        ...
        <div className="w-full min-h-screen p-4 bg-gray-50/50 flex flex-col items-center relative">
            <div className="w-full max-w-3xl space-y-4">
                ...
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="h-9 w-9 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 cursor-pointer">
                ...
                {/* Hero Summary Card */}
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-xs flex flex-col items-center text-center relative mt-4">
          ...
          />
                ...
                <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs space-y-4">
                    <h3 className="text-sm font-bold text-gray-900 tracking-wide">Transaction Details</h3>
                    
                    <div className="space-y-3.5 text-sm">
                        {/* Credited To Row */}
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">Credited to</span>
                            <button type="button" className="flex items-center text-gray-800 font-medium hover:text-emerald-600 transition-colors cursor-pointer text-right">
                        ...
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="text-right">
                                <p className="font-medium text-gray-800">{receiptData.senderName}</p>
                                <p className="text-xs text-gray-400">{receiptData.senderBank} | {receiptData.senderPhone}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <span className="font-medium text-gray-800 text-right break-all max-w-[70%]">{receiptData.remark}</span>
                        </div>

                        {/* Transaction Type Row */}
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">Transaction Type</span>
                            <span className="font-medium text-gray-800">{receiptData.transactionType}</span>
                        </div>

                        {/* Transaction No Row with Clipboard Copy */}
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">Transaction No.</span>
                            <div className="flex items-center gap-1.5 text-gray-800 font-mono text-xs">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="font-medium text-gray-800">{receiptData.transactionDate}</span>
                        </div>

                        {/* Session ID Row with Clipboard Copy */}
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">Session ID</span>
                            <div className="flex items-center gap-1.5 text-gray-800 font-mono text-xs max-w-[70%]">
                ...
                {/* More Actions Card */}
                <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs space-y-4">
                    <h3 className="text-sm font-bold text-gray-900 tracking-wide">More Actions</h3>
                    
                    {/* Category Selection Action Link Item */}
                    <div className="flex items-center justify-between text-sm pb-1">
                        <span className="text-gray-400">Category</span>
                        <button type="button" className="flex items-center text-gray-800 font-medium hover:text-emerald-600 transition-colors cursor-pointer">
